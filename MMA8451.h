 ...
 * global macro
 */
#define MMA8451_I2C_ADDRESS    0x1D << 1   // SA0 = 1
//#define MMA8451_I2C_ADDRESS    0x1C << 1   // SA0 = 0
...
enum {
	Full_Scale_Range_2g = 0,
	Full_Scale_Range_4g = 1,
	Full_Scale_Range_8g = 2,
};
...
/* Global variables */
//extern  uint16_t  resultx, resulty, resultz;
extern  uint8_t  resultx, resulty, resultz;

extern void MMA8451_Standby(void);
extern void MMA8451_Active(void);
extern void MMA8451WriteRegister(uint8_t address, uint8_t reg,uint8_t val);
extern uint8_t u8MMA8451ReadRegister(uint8_t address, uint8_t reg);
extern void MMA8451WriteRegister_N(uint8_t address, uint8_t reg1,uint8_t N,uint8_t *array);
extern void MMA8451ReadRegister_N(uint8_t address, uint8_t reg1,uint8_t N,uint8_t *array);
extern void MMA8451_Read_3axis_data(void);
extern void MMA8451_Initial(void);
